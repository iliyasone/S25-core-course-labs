| Lab | Expected points | Bonus / extra evidence |
| --- | --- | --- |
| Lab 01 - DevOps Info Service: Web Application Development | ✅ 10 | 📦 Used uv as a Python Package Manager |
| Lab 02 - Docker Containerization | ✅ 10 | 📦 Extra multi-stage Python image optimization is documented with a size comparison. |
| Lab 03 - Continuous Integration (CI/CD) | ✅ 10 | 🔍 Extra quality gates include coverage upload to Codecov and Snyk security scanning before Docker publish. |
| Lab 04 - Infrastructure as Code (Terraform & Pulumi) | ✅ 10 |  |
